...
class SWBOC_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo "<h2 class=\"widgettitle\">".$swboc_title."</h2>";
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('swboc_id'); ?>">ID:
		<input class="widefat" id="<?php echo $this->get_field_id('swboc_id'); ?>" name="<?php echo $this->get_field_name('swboc_id'); ?>" type="text" value="<?php echo $swboc_id; ?>" /></label>
